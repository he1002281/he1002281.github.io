var scheme = -1;
function lever(){
  document.getElementById("home").innerHTML = '<h2>Levers</h2> <p> Levers are composed of a fulcrum and a rod/platform. </p> <p> There are 3 classes of levers: </p> <p>  - Class 1: fulcrum between load and effort</p><p>  - Class 2: load between fulcrum and effort </p> <p>  - Class 3: effort between fulcrum and load</p><img src="https://lh3.googleusercontent.com/proxy/L0bFD_KFDZ67Jognm0LHEqSBudFP1XS76fxAOT9a7BXaws_B4kr3YV_8FnFAvn1gyP7ZFfgyWMgMQrWIoyqZi4Z2MqQmeDMK5NfNvW8" width="300" height="339"><p>Ideal mechanical advantage of a lever = (distance between effort and fulcrum)/(distance between load and fulcrum) </p> <img src="https://lh3.googleusercontent.com/proxy/45HSq1scqSm05bAcqWw38yxzHLVAHc8iOjmmPwnWKaAPOpFuzMMbOyKNT_CIV-ZkH8rCdEmC7CNKBmjG8Wbgk8I0mj2SnzoO1Su3x7TgAOz7H_dC6HVZFcpaHD5H0SksurcZZqV_wiX_lKjtdqYcP4dn" width="300" height="300"> <p><a href="https://www.youtube.com/watch?v=E8RA9Kw_IaE">Levers video</a><p><p></p>';
  color();
}
function pulley(){
  document.getElementById("home").innerHTML = '<h2>Pulleys</h2><p>A pulley is a wheel on an axle that supports changes in direction of a string or similar material.</p><p>Ideal mechanical advantage: equivalent to the number of strings supporting load</p><img src="https://lh3.googleusercontent.com/proxy/-NBYyDtGEnnEepnNzpsR2leN-TX-CYmWw3ZjNxFoOBpgdePy4IfVBbmqbm2wKs7FdWnqyyhbVcEa7JqDSqibatt1Rp3LxXQaMhwRzVWIDkyg9Md7gcx8JJTc9ZvQ7DtLdTCyjGDDFQwj-UkJQ2X28mDTnQ" width="326" height="274><p><a href="https://www.youtube.com/watch?v=LiarGb_LK10">Pulleys video</a></p><p></p>';
  color()
}
function wheel(){
  document.getElementById("home").innerHTML = '<h2>Wheel and axle</h2><p>A wheel is essentially a lever for rotational force with the wheel as the platform and the axle as the fulcrum.</p><p>Ideal mechanical advantage : (radius of wheel)/(radius of axle)</p><img src="https://lh3.googleusercontent.com/proxy/sKhZo52EpzKk6DOgMj091MbEXuS8YzRTz6QNoGrWC-604nX7zMljuJ7NVx_fZBztyYFh0bAFruX8TC3lWYRWoOZnVZRF-rgpcmMHckEhUv5Sk4ZyCER76c0aWbs_-CT47hse9XRNSvrW2X71gAkytKI" width="300" height="300"><p><a href="https://www.youtube.com/watch?v=ndT35aqDfAQ">Wheel and axle video</a></p><p></p>';
  color()
}
function inclined(){
